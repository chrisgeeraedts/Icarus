...
namespace Icarus.Logic.Shared.Managers
{
    public class EffectManager : IManager
    {
        ...
        public EffectManager(IGameWorldManager gameWorldManager)
        {
        ...
        public bool ShuffleCardIntoPile(ShuffleCardIntoPileEffect shuffleCardIntoPileEffect)
        {
            ...
            {
                // Generate a new card
                BaseCard baseCard = (Activator.CreateInstance(shuffleCardIntoPileEffect.CardToShuffle) as BaseCard);
        ...
        {
            return DamageTarget(card, new DamageMultipleTimesEffect(){DamageAmount = _gameWorldManager.HeroManager.StatusValues[StatusEffect.Block] , HitTimes = 1}, targets);
        }
        ...
        public bool AddBlockSelf(int baseBlock)
        {
            ...
            _gameWorldManager.HeroManager.StatusValues[StatusEffect.Block] += baseBlock;
        ...
        public bool AddStrengthSelf(int baseStrength)
        {
            ...
            _gameWorldManager.HeroManager.StatusValues[StatusEffect.Strength] += baseStrength;
        ...
        public bool AddWeakSelf(int baseWeak)
        {
            ...
            _gameWorldManager.HeroManager.StatusValues[StatusEffect.Weak] += baseWeak;
        ...
        public bool AddVulnerableSelf(int baseVulnerable)
        {
            ...
            _gameWorldManager.HeroManager.StatusValues[StatusEffect.Vulnerable] += baseVulnerable;
