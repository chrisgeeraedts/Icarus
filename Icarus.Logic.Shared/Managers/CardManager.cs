    ...
    public class CardManager : IManager
    {
        ...
        public ICardInstance LastCardExhausted
        {
            ...
            set
            {
                ...
                if (_lastCardExhausted.BaseCard.CardUseType == CardUseType.Exhaust)
                {
        ...
        public ICardInstance LastCardDiscarded
        {
            ...
            set
            {
                ...
                if (_lastCardDiscarded.BaseCard.CardUseType == CardUseType.Default)
                {
        ...
        public void FillDeck()
        {
            ...
            {
                DeckPile.Add(new CardInstance(heroDeckCard, GameWorldManager));
            }
        }
        ...
        public void AddCardToPile(ICardInstance newCard, CardMovePoint shuffleTargetPile, ShuffleFormat shuffleFormat)
        {
            ...
            GameWorldManager.EventManager.ShuffleCard(newCard.GetType(), shuffleTargetPile, shuffleFormat);
        }
        ...
        public void CreateRandomCard(CardColor targetCardColor, CardType targetCardType, CardMovePoint targetCardMovePoint, ShuffleFormat shuffleFormat)
        {
            ...
            ICardInstance newCard = new CardInstance(filteredListByColorAndType[randomIndex], GameWorldManager);
