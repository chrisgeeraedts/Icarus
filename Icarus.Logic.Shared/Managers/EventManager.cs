...
namespace Icarus.Logic.Shared.Managers
{
    public class EventManager
    {
        ...
        public delegate void NewLogMessageEventArgsHandler(object sender, NewLogMessageEventArgs e);
        public event NewLogMessageEventArgsHandler OnNewLogMessage;
        ...
        {
            if (OnNewLogMessage == null) return;
            NewLogMessageEventArgs args = new NewLogMessageEventArgs() { LogMessage = message};
            OnNewLogMessage(this, args);
        }
    }
}